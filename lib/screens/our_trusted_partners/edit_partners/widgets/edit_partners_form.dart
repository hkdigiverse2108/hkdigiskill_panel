...
class EditPartnersForm extends GetView<EditPartnersController> {
  const EditPartnersForm(this.partner, {super.key});
  ...
  Widget build(BuildContext context) {
    return GetBuilder(
      init: EditPartnersController(),
      initState: (state) {
        controller.initPartner(partner);
      },
      builder: (a) {
        return AdminRoundedContainer(
          ...
          child: Form(
            key: controller.editPartnersFormKey,
            child: Column(
                  ...
                  () => SizedBox(
                    ...
                    child: ElevatedButton(
                      onPressed: controller.isLoading.value
                          ? null
                          : () {
                              controller.updatePartners(partner);
                            },
