...
class WorkshopTestimonialsController extends GetxController {
  static WorkshopTestimonialsController get instance => Get.find();
  ...
  void fetchTestimonials() async {
    try {
      ...
      final response = await apiService.get(
        path: ApiConstants.testimonials(DashType.workshop),
