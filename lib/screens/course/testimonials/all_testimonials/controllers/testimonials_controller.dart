...
class CourseTestimonialsController extends GetxController {
  static CourseTestimonialsController get instance => Get.find();
  ...
  void fetchTestimonials() async {
    try {
      ...
      final response = await apiService.get(
        path: ApiConstants.testimonials(DashType.course),
